 ...
 */
public class Projeckbox extends Application implements Runnable {
    ...
    private void update() {
        if(inputKeyboard.contains( "RIGHT" )){//Menggerakkan kotak ke kanan saat Key RIGHT ditekan 
            cx+=2;
        }else if(inputKeyboard.contains( "LEFT" )){//mengerakkan kotak ke kiri saat Key LEFT ditekan 
            cx-=2;
        }
        
        if(inputKeyboard.contains( "UP" )){//mengerakkan kotak ke atas saat Key UP ditekan 
            cy-=2;
        }else if(inputKeyboard.contains( "DOWN" )){//mengerakkan kotak ke bawah saat Key DOWN ditekan 
            cy+=2;
        }
